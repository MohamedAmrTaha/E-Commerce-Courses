      ...
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-8">
            <ul className="space-y-4">
              {
                cart.map(item=>(
                  ...
                  <img
                    src={process.env.NEXT_PUBLIC_REACT_APP_UPLOAD_URL+item?.product?.image?.url}
            ...
            <h2 className='text-gray-400 text[12px]'>Note: All your items will be sent via email</h2>
          </div>
        </div>
      </div>
    </section>
